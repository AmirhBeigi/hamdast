...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: cH6HwN-ss2es/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: gnuET5DaB7nZ/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__kwo5J)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__rTun)}
              />
            </React.Fragment>
          ),
          value: args.children
