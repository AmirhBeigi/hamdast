...
import sty from "./PlasmicModal.module.css"; // plasmic-import: kih77aF909SP/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_9bLOq86y6Ga7"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__oaO8W)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {$props.showFooter ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__oNe5F)}
                    >
                      <Button2
                        color={"muted"}
                        label={
